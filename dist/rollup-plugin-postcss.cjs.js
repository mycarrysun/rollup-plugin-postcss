    ...
    load(id) {
      return new Promise(function ($return, $error) {
        if (hasQuery(id)) {
          ...
          return Promise.resolve(fs.readFile(file ? path.resolve(path.dirname(bareId), file) : bareId, 'utf8')).then(function ($await_3) {
            try {
              content = $await_3;
    ...
    onwrite(opts, bundle) {
      return new Promise(function ($return, $error) {
        ...
        getExtracted = filepath => {
          ...
          if (bundle.modules) {
            entries.sort((a, b) => bundle.modules.indexOf(a[0]) - bundle.modules.indexOf(b[0]));
          } // eslint-disable-next-line no-unused-vars


          for (var _i = 0; _i < entries.length; _i++) {
            const _entries$_i = _slicedToArray(entries[_i], 2),
                  _ = _entries$_i[0],
                  res = _entries$_i[1];
